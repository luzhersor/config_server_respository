...
public class CityService implements ICityService{
   ...
   private IHotelsAPI hotelsAPI;
    ...
    //CircuiteBreaker debe tener dos parametros, el nombre
    //del servicio que puede fallar y el fallBackMethod,
    //es un metodo al cual redirigir en caso de errores.
    @Override
    ...
    public CityDTO getCitiesHotels(String name, String country) {
        ...
        //Estamos provocando el fallo al propósito
        //Creamos la excepcion para que falle
        //createException();

        return cityDTO;
    }

    //Desviamos el circuito hasta que podamos comunicarnos nuevamente
